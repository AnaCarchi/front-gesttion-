...
@Component({
  ...
  template: `
    <h2>Vinculación con la Comunidad</h2>
    ...
    <div *ngIf="assignment; else noVinculation">
      ...
      <div class="upload">
        <label>Subir documento de vinculación</label>
    ...
    <ng-template #noVinculation>
      <p class="empty">
        No tienes vinculación asignada en este periodo.
      </p>
    </ng-template>
  `,
  styles: [`
