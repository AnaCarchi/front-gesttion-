...
@Component({
  ...
  template: `
    ...
    <div *ngIf="assignment; else noPreprofessional">
    ...
    <ng-template #noPreprofessional>
      <p class="empty">
        No tienes prácticas preprofesionales asignadas en este periodo.
      </p>
    </ng-template>
  `,
  styles: [`
...
export class InternshipPreprofessionalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assignment = this.assignmentService.getAll().find(a =>
      ...
      a.type === 'PREPROFESSIONAL_PRACTICE'
    );
  }
